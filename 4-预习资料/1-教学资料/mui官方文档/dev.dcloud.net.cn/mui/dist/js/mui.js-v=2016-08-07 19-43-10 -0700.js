            ...
            if (hasPulldown || hasPullup) {
                ...
                if (container) {
                    ...
                    if ($container.length === 1) {
                        if ($.os.plus && $.os.android) { //5+ android
                            $.plusReady(function() {
...
(function($, window, document, undefined) {
	...
	var Scroll = $.Class.extend({
		...
		_transitionTime: function(time) {
			...
			if (this.options.fixedBadAndorid && !time && $.os.isBadAndroid) {
				this.scrollerStyle['webkitTransitionDuration'] = 'http://dev.dcloud.net.cn/mui/dist/js/0.001s';
				if (this.parallaxElement && this.options.scrollY) { //目前仅支持竖向视差效果
					this.parallaxStyle['webkitTransitionDuration'] = 'http://dev.dcloud.net.cn/mui/dist/js/0.001s';
				}
			}
			if (this.indicators) {
	...
	var Indicator = function(scroller, options) {
		...
		if (this.options.fade) {
			...
			this.wrapperStyle['webkitTransitionDuration'] = this.options.fixedBadAndorid && $.os.isBadAndroid ? 'http://dev.dcloud.net.cn/mui/dist/js/0.001s' : '0ms';
	...
	Indicator.prototype = {
		...
		transitionTime: function(time) {
			...
			if (this.scroller.options.fixedBadAndorid && !time && $.os.isBadAndroid) {
				this.indicatorStyle['webkitTransitionDuration'] = 'http://dev.dcloud.net.cn/mui/dist/js/0.001s';
			}
		},
